...
public class CreditCardServiceImpl implements CreditCardService {
    ...
    public Page<CreditCardDTO> findAllWithEagerRelationships(Pageable pageable) {
        return creditCardRepository.findAllWithEagerRelationships(pageable).map(creditCardMapper::toDto);
    }
    ...
    public Optional<CreditCardDTO> findOne(Long id) {
        ...
        return creditCardRepository.findOneWithEagerRelationships(id).map(creditCardMapper::toDto);
    }
